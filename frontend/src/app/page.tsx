...
function Section({ children, className = "", delay = 0 }: { children: React.ReactNode; className?: string; delay?: number }) {
  ...
  return (
    <div ref={ref} className={visible ? `animate-fade-slide-up animate-delay-${delay * 100}` : `opacity-0 ${className}`} style={{ animationDelay: `${delay}s` }}>
      {children}
    </div>
  );
}
...
function CustomCursor() {
  ...
  return <div className={`custom-cursor ${hover ? 'hover' : ''}`} style={{ left: pos.x - 4, top: pos.y - 4 }} />;
}

// --- Main Page ---
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0A0A0A] selection:bg-[#E8834A] selection:text-[#0A0A0A]">
      <CustomCursor />
      <Navbar />

      {/* HERO */}
      <section className="relative min-h-screen flex flex-col justify-center px-6 pt-24 pb-16 ambient-glow">
          ...
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-6">
                <a href="#tool" className="bg-[#E8834A] text-[#0A0A0A] px-7 py-3 rounded-full text-sm font-semibold tracking-wide transition-all duration-300 hover:shadow-[0_0_40px_rgba(232,131,74,0.3)]">
                  Probar gratis
                </a>
      ...
      <section className="py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Section delay={0.4} className="lg:col-span-2">
              <div className="bento-card p-8 h-full">
                <div className="flex items-center gap-3 mb-4">
      ...
      <section id="how" className="py-32 px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-24">
            <Section delay={0.1} className="relative pl-16 md:pl-28">
              <span className="number-deco">01</span>
            ...
            <Section delay={0.2} className="relative pl-16 md:pl-28">
              <span className="number-deco">02</span>
              <div className="relative z-10">
            ...
            <Section delay={0.3} className="relative pl-16 md:pl-28">
              <span className="number-deco">03</span>
              <div className="relative z-10">
